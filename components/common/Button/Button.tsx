...
export const Button: FC<Button> = ({ class_, text }) => {
    return (
        <button className={`${class_} flex items-center h-[50px] w-full justify-center  `}>{text} <span className='pl-2  h-full flex justify-center items-center my-auto'><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
