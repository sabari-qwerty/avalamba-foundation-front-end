        ...
        <Section id='Blog'>
            <div className='w-[90%] flex flex-col space-y-16' >
                ...
                <div className='flex lg:flex-row xsm:flex-col xsm:m-auto lg:w-full xms:space-y-8 lg:space-y-0 gap-2'>
                    {
                        Articles_data.map((i, k) => <div key={k} className='lg:w-1/4 flex flex-col    rounded-lg mx-auto items-center space-y-8'>
                            <div className='      w-[90%] min-h-[240px] '>
                                <img src={i.src} alt="image" className='object-cover w-full min-h-[280px] rounded-lg' />
                            </div>
                            <div className=' flex flex-col space-y-2 w-[90%]'>
                                ...
                                <div className='flex flex-col space-y-2'>
                                    ...
                                    <Paragraph text={i.text} class_='text-[10px] font-normal pb-3 ' />
                                </div>
                            </div>
                        </div>)
                    }
